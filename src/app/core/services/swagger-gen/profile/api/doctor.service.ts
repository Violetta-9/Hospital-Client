...
export class DoctorService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDoctorsBySpecializationId( specializationId?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<DoctorAllDTO>>;
    public getDoctorsBySpecializationId( specializationId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DoctorAllDTO>>>;
    public getDoctorsBySpecializationId( specializationId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DoctorAllDTO>>>;
    public getDoctorsBySpecializationId( specializationId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<DoctorAllDTO>>('get',`${this.basePath}/api/Doctor/specialization`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
